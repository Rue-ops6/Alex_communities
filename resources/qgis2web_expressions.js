...
function exp_AlexandrianGreeks_3rule0_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == '1');
    } else {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == '1');
    }
}
...
function exp_AlexandrianGreeks_3rule1_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == '2');
    } else {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == '2');
    }
}
...
function exp_AlexandrianGreeks_3rule2_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == '3');
    } else {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == '3');
    }
}
...
function exp_AlexandrianGreeks_3rule3_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == 'mixed');
    } else {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == 'mixed');
    }
}
...
function exp_AlexandrianGreeks_3rule4_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == 0);
    } else {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == 0);
    }
}
...
function exp_AlexandrianGreeks_3rule5_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == '4');
    } else {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == '4');
    }
}
...
function exp_AlexandrianGreeks_3rule6_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == '5');
    } else {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == '5');
    }
}
...
function exp_AlexandrianGreeks_3rule7_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == 6);
    } else {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == 6);
    }
}
...
function exp_AlexandrianGreeks_3rule8_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == '7');
    } else {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == '7');
    }
}
...
function exp_AlexandrianGreeks_3rule9_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == '8');
    } else {
        return (feature.get('AlexandrianGreeks — Form responses 1_Field6')  == '8');
    }
}
