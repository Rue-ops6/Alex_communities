...
lyr_AlexandrianGreeks_3.set('fieldAliases', {'id': 'id', 'Timestamp': 'AlexandrianGreeks — Form responses 1_Field2', 'Surveyor': 'AlexandrianGreeks — Form responses 1_Field3', 'latitude and longitude': 'AlexandrianGreeks — Form responses 1_Field4', 'Element name': 'AlexandrianGreeks — Form responses 1_Field5', 'Element type': 'AlexandrianGreeks — Form responses 1_Field6', 'Its owner': 'AlexandrianGreeks — Form responses 1_Field7', 'Old picture': 'AlexandrianGreeks — Form responses 1_Field8', 'New picture': 'AlexandrianGreeks — Form responses 1_Field9', 'Its date': 'AlexandrianGreeks — Form responses 1_Field10', 'Its description': 'AlexandrianGreeks — Form responses 1_Field11', 'AlexandrianGreeks — Form responses 1_Field12': 'AlexandrianGreeks — Form responses 1_Field12', });
lyr_AlexandrianGreeks_3.set('fieldImages', {'id': 'TextEdit', 'Timestamp': 'TextEdit', 'Surveyor': 'TextEdit', 'latitude and longitude': 'TextEdit', 'Element name': 'TextEdit', 'Element type': 'TextEdit', 'Its owner': 'TextEdit', 'Old picture': 'ExternalResource', 'New picture': 'ExternalResource', 'Its date': 'TextEdit', 'Its description': 'TextEdit', 'AlexandrianGreeks — Form responses 1_Field12': 'TextEdit', });
lyr_AlexandrianGreeks_3.set('fieldLabels', {'id': 'no label', 'Timestamp': 'no label', 'Surveyor': 'no label', 'latitude and longitude': 'no label', 'Element name': 'no label', 'Element type': 'no label', 'Its owner': 'no label', 'Old picture': 'no label', 'New picture': 'no label', 'Its date': 'no label', 'Its description': 'no label', 'AlexandrianGreeks — Form responses 1_Field12': 'no label', });
